...
return {
	...
	vim.keymap.set("n", "[d", "<Cmd>Lspsaga diagnostic_jump_next<cr>", opts), --跳转到上一个诊断问题
	vim.keymap.set("n", "gd", "<Cmd>Lspsaga finder<cr>", opts), -- 设置在普通模式下，使用 gd 打开 lspsaga 的查找定义功能
	vim.keymap.set("n", "go", "<cmd>Lspsaga goto_definition<CR>", opts), -- 使用 Lspsaga 去声明地
